...
// src/cli.ts
var getVoicesCommand = defineCommand({
  meta: {
    name: "get-voices",
  ...
  run: async () => {
    ...
    Object.entries(voicesByLocale).sort(([localeA], [localeB]) => localeA.localeCompare(localeB)).forEach(([locale, localeVoices]) => {
      console.log(`
${locale}:`);
...
var synthesizeCommand = defineCommand({
  meta: {
    name: "synthesize",
